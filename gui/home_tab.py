...
def init_home_tab(main_window):
    ...
    main_window.status_label.setStyleSheet("font-size: 16px; color: #FF0000; font-weight: bold;")

    # Last offsets update label.
    main_window.last_update_label = QLabel("Last offsets update: Fetching...")
    main_window.last_update_label.setStyleSheet("font-size: 16px; font-style: italic;")
